...
const I18N = {
  ja: {
    ...
    homeCountingTitle: "手数の数え方",
    homeCountingCopy: "王手 → 応手 → 詰みで3手。チェス式では Mate in 2 相当です。",
    randomAll: "全問題からランダム",
    randomAllCopy: "いまの問題を避けて、一問選びます。",
    settings: "設定",
    close: "閉じる",
    closeSettings: "設定を閉じる",
    closePuzzleList: "問題一覧を閉じる",
    closePieceGuide: "駒の動きを閉じる",
    closeRules: "ルールを閉じる",
    boardRegion: "詰将棋の盤面",
    howToPlay: "遊び方",
    defender: "玉方",
    ...
    chessComparisonTitle: "チェス経験者へ",
    chessComparisonCopy: "チェスの「Mate in 2」は最大3回の着手です。詰将棋では双方の着手を数えるため、同じ長さを「3手詰め」と呼びます。",
    attackCheck: "攻め方・王手",
    defenseReply: "玉方・応手",
    attackMate: "攻め方・詰み",
    ...
    puzzleLabel: "問題",
    mateInN: "{n}手詰め",
    compactMateOne: "{n}手詰め",
    compactMateMany: "{n}手詰め",
    puzzleCountOne: "{n}問",
    puzzleCountMany: "{n}問",
    dropSuffix: "打",
    promoteSuffix: "成",
  ...
  en: {
    brandTagline: "Learn to calculate mate, one move at a time.",
    home: "Home",
    homeKicker: "CALCULATION PRACTICE",
    homeTitle: "Spot the mate, one move at a time.",
    homeIntro: "Continue where you left off or choose a puzzle length.",
    continuePractice: "Continue",
    learningRecord: "Practice record",
    homeCompleted: "{done} / {total} completed",
    chooseByLength: "Choose a puzzle length",
    chooseByLengthCopy: "Start with short lines, then calculate further ahead.",
    homeCountingTitle: "How tsume counts",
    homeCountingCopy: "Check → reply → mate = 3 plies. In chess, that is mate in 2.",
    randomAll: "Random from all puzzles",
    randomAllCopy: "Choose one puzzle, avoiding the current one.",
    settings: "Settings",
    close: "Close",
    closeSettings: "Close settings",
    closePuzzleList: "Close puzzle list",
    closePieceGuide: "Close piece guide",
    closeRules: "Close rules",
    boardRegion: "Tsume shogi puzzle board",
    howToPlay: "HOW TO PLAY",
    defender: "Defender",
    escapeGoal: "Cover every escape square",
    yourTurn: "Your move",
    yourPieces: "Pieces in hand",
    tapPiece: "Select a piece, then choose its destination",
    ...
    answerConfirmTitle: "Show the solution?",
    ...
    answerPause: "Pause",
    answerPlay: "Autoplay",
    answerStepProgress: "{current} / {total} plies",
    ...
    promotionGuideCopy: "Promotion can add new moves or make a piece move like a Gold General.",
    goldPromotions: "Tokin and promoted S, N, L",
    goldPromotionsCopy: "A promoted Pawn, Silver General, Knight, or Lance moves one square in the six Gold General directions.",
    ...
    rulesLead: "Tsume shogi is a checkmate puzzle. Force mate in the stated number of plies, giving check on every attacking turn.",
    ...
    countingMoves: "How a 3-ply tsume is counted",
    countingMovesCopy: "A ply is one turn by either side. Your check, the defender's reply, and your checkmate make three plies.",
    chessComparisonTitle: "Coming from chess?",
    chessComparisonCopy: "A 3-ply tsume is the same length as chess “mate in 2”: chess counts the attacker's moves, while tsume counts every turn.",
    ...
    bestDefenseCopy: "When several replies exist, the defender chooses the line that delays mate longest. Any unshown piece except a King may be used from the defender's hand to block a check. The app chooses the reply automatically.",
    whatIsMate: "What is checkmate?",
    whatIsMateCopy: "The king cannot escape, capture the checking piece, or block the check.",
    useAllHandPieces: "Finish with no pieces left in hand",
    useAllHandPiecesCopy: "In this app, a correct solution uses every piece shown in the attacker's hand.",
    importantRule: "Illegal moves to remember",
    importantRuleCopy: "Nifu (two unpromoted Pawns on one file), uchifuzume (checkmate by a Pawn drop), and drops that leave a piece with no legal move are illegal, just as in regular shogi.",
    officialTsumeRules: "Read the Japan Shogi Association tsume rules",
    language: "Language",
    languageNote: "Choose the language used throughout the app.",
    judgement: "Feedback timing",
    judgementQuick: "Feedback",
    judgementImmediate: "Check every move",
    judgementImmediateCopy: "Checks each move against the solution",
    judgementEnd: "Play through",
    judgementEndCopy: "Only stops when the line can no longer lead to mate",
    ...
    pickerSummary: "Choose a 1-, 3-, 5-, 7-, or 9-ply tsume",
    filterByMoves: "Choose puzzles by the total number of plies.",
    allPuzzles: "All puzzles",
    comingSoon: "Coming soon",
    noPuzzlesYet: "Puzzles of this length will be added here.",
    learn: "LEARN",
    guideIntro: "Your pieces point toward the top of the board (▲). Dots, arrows, and diamonds show how each piece moves.",
    ...
    promote: "Promote",
    mateInOne: "1-ply tsume",
    mateInThree: "3-ply tsume",
    beginner: "Beginner",
    ...
    notMate: "Take another look",
    notCheckCopy: "That move is not check. In tsume shogi, every attacking move must give check.",
    failedTitle: "No checkmate",
    failedCopy: "The line reached its stated length without checkmate. Reset and calculate the position again.",
    noChecksTitle: "No more checks",
    noChecksCopy: "The chain of checks is broken. Reset and calculate from the starting position again.",
    hintOffLineCopy: "You have left the solution line. Reset and calculate from the starting position again.",
    ...
    goodCheck: "Check",
    goodCheckCopy: "The defender will choose the reply that delays mate longest.",
    ...
    sequenceEmpty: "Your move sequence will appear here",
    ...
    boardLabel: "9×9 shogi board",
    selectedPiece: "Selected",
    puzzleLabel: "Puzzle",
    mateInN: "{n}-ply tsume",
    compactMateOne: "{n} ply",
    compactMateMany: "{n} plies",
  ...
  fr: {
    brandTagline: "Apprenez à calculer le mat, un coup à la fois.",
    home: "Accueil",
    homeKicker: "EXERCICE DE CALCUL",
    homeTitle: "Trouvez le mat, un coup à la fois.",
    homeIntro: "Reprenez où vous en étiez ou choisissez une longueur.",
    continuePractice: "Continuer",
    learningRecord: "Progression",
    homeCompleted: "{done} / {total} terminés",
    chooseByLength: "Choisir une longueur",
    chooseByLengthCopy: "Commencez par des variantes courtes, puis calculez plus loin.",
    homeCountingTitle: "Compter les demi-coups",
    homeCountingCopy: "Échec → réponse → mat = 3 demi-coups. Aux échecs, cela correspond à un mat en 2.",
    ...
    closePuzzleList: "Fermer la liste des problèmes",
    closePieceGuide: "Fermer le guide des pièces",
    closeRules: "Fermer les règles",
    boardRegion: "Plateau du problème de tsume shogi",
    howToPlay: "RÈGLES DU JEU",
    defender: "Défenseur",
    escapeGoal: "Fermez toutes les cases de fuite",
    yourTurn: "À vous de jouer",
    yourPieces: "Pièces en main",
    tapPiece: "Sélectionnez une pièce, puis sa destination",
    ...
    answerPause: "Pause",
    answerPlay: "Lecture automatique",
    answerStepProgress: "{current} / {total} demi-coups",
    ...
    promotionGuideCopy: "La promotion ajoute des mouvements ou donne le déplacement du Général d'or.",
    goldPromotions: "Tokin et S, N, L promus",
    goldPromotionsCopy: "Le Pion, le Général d'argent, le Cavalier et la Lance promus se déplacent comme le Général d'or.",
    ...
    rulesLead: "Le tsume shogi est un problème de mat. Forcez le mat dans le nombre de demi-coups indiqué, en donnant échec à chaque tour de l'attaquant.",
    ...
    countingMoves: "Compter un tsume en 3 demi-coups",
    countingMovesCopy: "Un demi-coup est le tour d'un seul camp. Votre échec, la réponse du défenseur et votre mat font trois demi-coups.",
    chessComparisonTitle: "Vous venez des échecs ?",
    chessComparisonCopy: "Un tsume en 3 demi-coups a la même longueur qu'un « mat en 2 » aux échecs : les échecs comptent les coups de l'attaquant, le tsume compte chaque demi-coup.",
    ...
    bestDefenseCopy: "S'il existe plusieurs réponses, le défenseur choisit celle qui retarde le mat au maximum. Toute pièce absente, sauf le Roi, peut être prise en main pour s'interposer. L'appli choisit automatiquement la réponse.",
    ...
    useAllHandPieces: "Finir sans pièce en main",
    useAllHandPiecesCopy: "Dans cette appli, une solution correcte utilise toutes les pièces affichées dans la main de l'attaquant.",
    importantRule: "Coups illégaux à retenir",
    importantRuleCopy: "Le nifu (deux Pions non promus sur une même colonne), l'uchifuzume (mat par pose d'un Pion) et les poses sans coup légal futur sont interdits.",
    officialTsumeRules: "Lire les règles de tsume de la Japan Shogi Association",
    language: "Langue",
    languageNote: "Choisissez la langue utilisée dans toute l'application.",
    judgement: "Moment de la correction",
    judgementQuick: "Correction",
    judgementImmediate: "Vérifier chaque coup",
    judgementImmediateCopy: "Compare chaque coup à la solution",
    judgementEnd: "Jouer la ligne",
    judgementEndCopy: "Ne s'arrête que lorsque la variante ne peut plus mener au mat",
    ...
    pickerSummary: "Tsume en 1, 3, 5, 7 ou 9 demi-coups",
    filterByMoves: "Choisissez selon le nombre total de demi-coups.",
    allPuzzles: "Tous les problèmes",
    comingSoon: "Bientôt disponible",
    noPuzzlesYet: "Les problèmes de cette longueur seront ajoutés ici.",
    learn: "APPRENDRE",
    guideIntro: "Vos pièces pointent vers le haut du plateau (▲). Les points, flèches et losanges indiquent leurs déplacements.",
    ...
    failedCopy: "La variante a atteint la longueur annoncée sans mat. Recommencez et recalculez la position.",
    ...
    goodCheck: "Échec",
    goodCheckCopy: "Le défenseur choisira la réponse qui retarde le mat au maximum.",
    correctCheck: "Correct",
    ...
    sequenceEmpty: "Votre suite de coups apparaîtra ici",
    ...
    selectedPiece: "Sélection",
    puzzleLabel: "Problème",
    mateInN: "Tsume en {n} demi-coups",
    compactMateOne: "{n} demi-coup",
    compactMateMany: "{n} demi-coups",
    puzzleCountOne: "{n} problème",
    puzzleCountMany: "{n} problèmes",
    dropSuffix: " (depuis la main)",
    promoteSuffix: "+",
  },
  es: {
    brandTagline: "Aprende a calcular el mate, jugada a jugada.",
    home: "Inicio",
    homeKicker: "PRÁCTICA DE CÁLCULO",
    homeTitle: "Encuentra el mate, jugada a jugada.",
    homeIntro: "Continúa donde lo dejaste o elige la longitud del problema.",
    continuePractice: "Continuar",
    learningRecord: "Progreso",
    homeCompleted: "{done} / {total} completados",
    chooseByLength: "Elegir una longitud",
    chooseByLengthCopy: "Empieza con variantes cortas y calcula cada vez más lejos.",
    homeCountingTitle: "Cómo se cuentan",
    homeCountingCopy: "Jaque → respuesta → mate = 3 medias jugadas. En ajedrez, equivale a mate en 2.",
    randomAll: "Problema aleatorio",
    randomAllCopy: "Elige un problema distinto del actual.",
    settings: "Ajustes",
    close: "Cerrar",
    closeSettings: "Cerrar los ajustes",
    closePuzzleList: "Cerrar la lista de problemas",
    closePieceGuide: "Cerrar la guía de piezas",
    closeRules: "Cerrar las reglas",
    boardRegion: "Tablero del problema de tsume shogi",
    howToPlay: "CÓMO JUGAR",
    defender: "Defensor",
    escapeGoal: "Cierra todas las casillas de escape",
    yourTurn: "Tu turno",
    yourPieces: "Piezas en mano",
    tapPiece: "Selecciona una pieza y elige su destino",
    ...
    answerConfirmTitle: "¿Mostrar la solución?",
    ...
    answerStepProgress: "{current} / {total} medias jugadas",
    ...
    promotionGuideCopy: "La promoción añade movimientos o hace que la pieza se mueva como el General de oro.",
    goldPromotions: "Tokin y S, N, L promovidos",
    goldPromotionsCopy: "El Peón, el General de plata, el Caballo y la Lanza promovidos se mueven como el General de oro.",
    ...
    rulesLead: "El tsume shogi es un problema de mate. Fuerza el mate en el número indicado de medias jugadas, dando jaque en cada turno del atacante.",
    ruleCheck: "Dar jaque",
    ...
    countingMoves: "Cómo se cuenta un tsume de 3 medias jugadas",
    countingMovesCopy: "Una media jugada es el turno de un solo bando. Tu jaque, la respuesta del defensor y tu mate suman tres medias jugadas.",
    chessComparisonTitle: "¿Vienes del ajedrez?",
    chessComparisonCopy: "Un tsume de 3 medias jugadas dura lo mismo que un «mate en 2» de ajedrez: el ajedrez cuenta las jugadas del atacante; el tsume, cada turno.",
    ...
    bestDefenseCopy: "Si hay varias respuestas, el defensor elige la que más retrasa el mate. Cualquier pieza no mostrada, excepto el Rey, puede usarse desde su mano para bloquear. La app elige la respuesta automáticamente.",
    whatIsMate: "¿Qué es jaque mate?",
    whatIsMateCopy: "El rey no puede escapar, capturar la pieza atacante ni bloquear el jaque.",
    useAllHandPieces: "Termina sin piezas en la mano",
    useAllHandPiecesCopy: "En esta app, una solución correcta usa todas las piezas que aparecen en la mano del atacante.",
    importantRule: "Jugadas ilegales que recordar",
    importantRuleCopy: "El nifu (dos Peones sin promover en una misma columna), el uchifuzume (mate al colocar un Peón) y las colocaciones que dejan una pieza sin movimiento legal están prohibidos.",
    officialTsumeRules: "Leer las reglas de tsume de la Asociación Japonesa de Shogi",
    language: "Idioma",
    languageNote: "Elige el idioma que se usará en toda la aplicación.",
    judgement: "Momento de la corrección",
    judgementQuick: "Corrección",
    judgementImmediate: "Comprobar cada jugada",
    judgementImmediateCopy: "Compara cada jugada con la solución",
    judgementEnd: "Jugar la línea",
    judgementEndCopy: "Solo se detiene cuando la variante ya no puede llevar al mate",
    ...
    pickerSummary: "Tsume de 1, 3, 5, 7 o 9 medias jugadas",
    filterByMoves: "Elige según el número total de medias jugadas.",
    allPuzzles: "Todos los problemas",
    comingSoon: "Próximamente",
    noPuzzlesYet: "Los problemas de esta longitud se añadirán aquí.",
    learn: "APRENDER",
    guideIntro: "Tus piezas apuntan hacia la parte superior del tablero (▲). Los puntos, las flechas y los rombos indican sus movimientos.",
    ...
    goodCheck: "Jaque",
    goodCheckCopy: "El defensor elegirá la respuesta que más retrasa el mate.",
    ...
    sequenceEmpty: "Tu secuencia de jugadas aparecerá aquí",
    ...
    selectedPiece: "Selección",
    puzzleLabel: "Problema",
    mateInN: "Tsume de {n} medias jugadas",
    compactMateOne: "{n} turno",
    compactMateMany: "{n} turnos",
    puzzleCountOne: "{n} problema",
    puzzleCountMany: "{n} problemas",
    dropSuffix: " (desde la mano)",
    promoteSuffix: "+",
  },
};
...
const PIECES = {
  ...
  G: {
    kanji: "金", latin: "G",
    ja: "金将", en: "Gold General", fr: "Général d'or", es: "General de oro",
  ...
  S: {
    ...
    ja: "銀将", en: "Silver General", fr: "Général d'argent", es: "General de plata",
    promotedFr: "Général d'argent promu", promotedEs: "General de plata promovido",
  ...
  P: {
    ...
    moveFr: "Une case vers l'avant. Un pion posé depuis la main ne peut pas doubler un pion sur la même colonne.",
    moveEs: "Una casilla al frente. Un peón colocado desde la mano no puede crear dos peones en la misma columna.",
  },
};
...
function compactMateLabel(plies) {
  return t(plies === 1 ? "compactMateOne" : "compactMateMany").replace("{n}", plies);
}
...
function renderHome() {
  ...
  document.querySelectorAll("#home-length-options [data-home-plies]").forEach((button) => {
    ...
    button.querySelector("strong").textContent = compactMateLabel(plies);
...
function formatMove(entry) {
  ...
  if (preferences.language !== "ja") {
    const suffix = entry.kind === "drop" ? "*" : (entry.promote ? "+" : "");
    return `${mark}${info.latin}${suffix}${destination}`;
  }
  const name = info.kanji || info.kanjiDefense;
  const suffix = entry.kind === "drop" ? t("dropSuffix") : (entry.promote ? t("promoteSuffix") : "");
...
function bindEvents() {
  ...
  $("#home-counting-button").addEventListener("click", () => openSheet("#rules-layer"));
