...
const I18N = {
  ...
  en: {
    ...
    rulesLead: "Tsume shogi is a checkmate puzzle. Force mate in the stated number of moves, giving check on every attacking move.",
    ...
    countingMoves: "How a “3-move tsume” is counted",
    countingMovesCopy: "All moves count: your check, the defender's reply, and your final checkmate make three moves.",
    ...
    pickerSummary: "Choose a 1-, 3-, 5-, 7-, or 9-move tsume",
    filterByMoves: "Choose puzzles by the total number of moves.",
    ...
    promote: "Promote",
    mateInOne: "1-move tsume",
    mateInThree: "3-move tsume",
    beginner: "Beginner",
    ...
    failedCopy: "You used all the allowed moves without checkmate. Reset and calculate the position again.",
    ...
    puzzleLabel: "Puzzle",
    mateInN: "{n}-move tsume",
    compactMateOne: "{n} move",
    compactMateMany: "{n} moves",
  ...
  fr: {
    ...
    rulesLead: "Le tsume shogi est un problème de mat. Forcez le mat dans le nombre de coups indiqué en donnant échec à chaque coup d'attaque.",
    ...
    countingMoves: "Compter un « tsume en 3 coups »",
    countingMovesCopy: "Tous les coups comptent : votre échec, la réponse du défenseur et votre mat final font trois coups.",
    ...
    pickerSummary: "Tsume en 1, 3, 5, 7 ou 9 coups",
    filterByMoves: "Choisissez selon le nombre total de coups.",
    ...
    promote: "Promouvoir",
    mateInOne: "Tsume en 1 coup",
    mateInThree: "Tsume en 3 coups",
    beginner: "Débutant",
    ...
    failedCopy: "Tous les coups autorisés ont été joués sans mat. Recommencez et recalculez la position.",
    ...
    mateInN: "Tsume en {n} coups",
    compactMateOne: "{n} coup",
    compactMateMany: "{n} coups",
  ...
  es: {
    ...
    rulesLead: "El tsume shogi es un problema de mate. Fuerza el mate en el número de jugadas indicado, dando jaque en cada jugada del atacante.",
    ruleCheck: "Dar jaque",
    ...
    countingMoves: "Cómo se cuenta un «tsume de 3 jugadas»",
    countingMovesCopy: "Todas las jugadas cuentan: tu jaque, la respuesta del defensor y tu mate final suman tres jugadas.",
    ...
    pickerSummary: "Tsume de 1, 3, 5, 7 o 9 jugadas",
    filterByMoves: "Elige según el número total de jugadas.",
    ...
    promote: "Promover",
    mateInOne: "Tsume de 1 jugada",
    mateInThree: "Tsume de 3 jugadas",
    ...
    failedCopy: "Usaste todas las jugadas permitidas sin dar mate. Reinicia y vuelve a calcular la posición.",
    ...
    mateInN: "Tsume de {n} jugadas",
    compactMateOne: "{n} jugada",
    compactMateMany: "{n} jugadas",
